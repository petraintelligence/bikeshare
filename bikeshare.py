...
def get_filters():
    ...
    while True:
        while True:
            city_input = str(input("What city would you like to analyze:{}? ".format(cities)).title())
    ...
    # TO DO: get user input for month (all, january, february, ... , june)
        while True:
            month_input = str(input("What month would you like to filter for? If you would like see the data unfiltered, type 'all': ").lower())
    ...
    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
        while True:
            day_input = str(input("What day of the week would you like to filter for? If you would like see the data unfiltered, type 'all': ").lower())
        ...
        print("You chose the following filters: {}, {}, {}. ".format(city_final.title(), month_input.title(), day_input.title()))
        print('-'*40)
...
def station_stats(df):
    ...
    print('The most frequnt combination of start station and end station trip was {}'.format(combo.mode()[0]))
...
def trip_duration_stats(df):
    ...
    print('Passengers traveled a total of {} days, {} hours, {} minutes and {} seconds'.format(sum_days, sum_hours, sum_minutes, sum_seconds))
    ...
    print('Passengers traveled an average of {} hours, {} minutes and {} seconds'.format(mean_hours, mean_minutes, mean_seconds))
...
def user_stats(df):
    ...
    if 'Gender' not in df:
        ...
        print('Number of genders of users mentioned in the data are {}'.format(len(gender_counts)))
        for i in range(len(gender_counts)):
            print('{}s - {}'.format(gender_counts['Gender'][i], gender_counts['Start Time'][i]))
        print('Gender data for {} users is not available'.format(len(df)-gender_counts['Start Time'][0]-gender_counts['Start Time'][1]))
